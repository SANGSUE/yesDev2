            ...
            <nav class="navbar navbar-default">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"><b>YES</b> 설비공사</a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="#contact-section_nm">회사소개</a></li>
                            <li><a href="#new-section_nm">사업영역</a></li>
                            <li><a href="#featured-section_nm">시공사진</a></li>
                            <li><a href="#">Blog</a></li>
                            <li><a href="#contact-section_nm">Contact Us</a></li> 
 <!--                            <li><a href="#">회사소개</a></li>
                            <li><a href="#">사업영역</a></li>
                            <li><a href="#">시공사진</a></li>
                            <li><a href="#">Blog</a></li>
            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="images/waterproof1.jpg" width="1648" height="600" alt="">
                        <div class="carousel-caption">
							<h2>울산시 <b>&</b> 전 지역 </h2>
                            <h3>하수구/배관/방수 전문업체 <Span>YES</Span></h3>
                            <a href="#" style="font-size: 30px;" >010-5639-2012</a>
                        </div>
                    </div>
                    <div class="item">
                        <img src="images/drain2.jpg" width="1648" height="600" alt="">
                        <div class="carousel-caption">
                            <h2>울산시 <b>&</b> 전 지역 </h2>
                            <h3>하수구/배관/방수 전문업체 <Span>YES</Span></h3>
                            <a href="#" style="font-size: 30px;">010-5639-2012</a>
                    ...
                    <div class="item ">
                        <img src="images/piping1.jpg" width="1648" height="600" alt="">
                        <div class="carousel-caption">
                            <h2>울산시 <b>&</b> 전 지역 </h2>
                            <h3>하수구/배관/방수 전문업체 <Span>YES</Span></h3>
                            <a href="#" style="font-size: 30px;">010-5639-2012</a>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6 wow fadeInLeft animated" data-wow-delay="0.2s">
                        <div class="product-item">
                            <img src="images/piping2_item.jpg" class="img-responsive" width="255" height="322" alt="">
                            <div class="product-hover">
                                <div class="product-meta">                               
                                    <a href="#"><i class="pe-7s-cart"></i>세부정보</a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6 wow fadeInLeft animated" data-wow-delay="0.4s">
                        <div class="product-item">
                            <img src="images/drain1_item.jpg" class="img-responsive" width="255" height="322" alt="">
                            <div class="product-hover">
                                <div class="product-meta">
                                    <a href="#"><i class="pe-7s-cart"></i>세부정보</a>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-6 wow fadeInLeft animated" data-wow-delay="0.6s">
                        <div class="product-item">
                            <img src="images/seabattleAfter_item.jpg" class="img-responsive" width="255" height="322" alt="">
                            <div class="product-hover">
                                <div class="product-meta">
                                    <a href="#"><i class="pe-7s-cart"></i>세부정보</a>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-6 wow fadeInLeft animated" data-wow-delay="0.8s">
                        <div class="product-item">
                            <img src="images/waterproof2_item.jpg" class="img-responsive" width="255" height="322" alt="">
                            <div class="product-hover">
                                <div class="product-meta">
        ...
        <section class="featured-section">
            ...
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="filter-menu">
                            <ul class="button-group sort-button-group">
                                ...
                                <li class="button" data-category="cat-1">배관<span>2</span></li>
                                <li class="button" data-category="cat-2">변기/하수구<span>2</span></li>
                                <li class="button" data-category="cat-3">상하수도<span>4</span></li>
                                <li class="button" data-category="cat-4">방수<span>2</span></li>                               
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="row featured isotope">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 cat-3 featured-items isotope-item">
                        <div class="product-item">
                            <img src="images/seabattleBefore_item.jpg" class="img-responsive" width="255" height="322" alt="">
                            <div class="product-hover">
                                <div class="product-meta">
                                    <a href="#"><i class="pe-7s-cart"></i>세부정보</a>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 cat-2 featured-items isotope-item">
                        <div class="product-item">
                            <img src="images/toilet_item.jpg" class="img-responsive" width="255" height="322" alt="">
                            <div class="product-hover">
                                <div class="product-meta">
                                    <a href="#"><i class="pe-7s-cart"></i>세부정보</a>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 cat-1 featured-items isotope-item">
                        <div class="product-item">
                            <img src="images/piping1_item.jpg" class="img-responsive" width="255" height="322" alt="">
                            <div class="product-hover">
                                <div class="product-meta">
                                    <a href="#"><i class="pe-7s-cart"></i>세부정보</a>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 cat-4 featured-items isotope-item">
                        <div class="product-item">
                            <img src="images/waterproof3_item.jpg" class="img-responsive" width="255" height="322" alt="">
                            <div class="product-hover">
                                <div class="product-meta">
                                    <a href="#"><i class="pe-7s-cart"></i>세부정보</a>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div id="feedback" class="carousel slide feedback" data-ride="feedback">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img src="images/human_tie.png" width="320" height="439" alt="">
                                <div class="carousel-caption">
                                    <p>하수구가 막혀서 전화 드렸는데 20분내로 오셔서 바로 처리해주셨습니다.</p>
                                    <h3>- 울산 남구 -</h3>
                                    <span>강광훈 고객님</span>
                                </div>
                            </div>
                            <div class="item">
                                <img src="images/human_tie2.png" width="320" height="439" alt="">
                                <div class="carousel-caption">
                                    <p>방수공사 추천합니다. </p>
                                    <h3>- 울산 중구  -</h3>
                                    <span>김길호 고객님</span>
                            ...
                            <div class="item">
                                <img src="images/human_tie3.png" width="320" height="439" alt="">
                                <div class="carousel-caption">
                                    <p>상수도 공사 여기저기 알아봐서 했는데 제일 저렴합니다.</p>
                                    <h3>- 울산 울주군  -</h3>
                                    <span>김효석 고객님</span>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6 wow fadeInLeft animated">
                        <div class="left-content">
                            <h1><span>YES</span>설비공사</h1>
                            <h3>저희 업체를 방문해주셔서 진심으로 감사드립니다!</h3>
                            <p>예스설비는 집에 관련된 설비를 전문적으로 합니다. 꼼꼼한 시공과 a/s 보장까지 울산 1등 설비가 되겠습니다. 더불어 고객과 인연을 소중히 여기고, 울산 시민이 모두 고객이라 생각하고 울산 사회에 도움이 되는사회적 기업이 되겠습니다.</p>
                            <div class="contact-info">
                                <p><b>사업자정보 회사명:</b> 예스설비공사</p>
                                <p><b>사업자 번호:</b> 667-22-*****</p>
                                <p><b>사업자 주소:</b> 울산 남구 신정3동 199-18</p>
                                <p><b>대표자명:</b> 김건수</p>
                                <p><b>전화번호:</b> 010-5639-2012</p>
                                <p><b>Email:</b> kgs2125@naver.com</p>
                            </div>
